...
import { venmoExperienceContextSchema, type VenmoExperienceContext } from "./venmo-experience-context.js";

export type VaultVenmoRequest = {
  description?: string;
...
export const vaultVenmoRequestSchema: Schema<VaultVenmoRequest> = s.object<VaultVenmoRequest>({
  ...
  experienceContext: s.optional(s.lazy(() => venmoExperienceContextSchema)),
  _keysMap: {
