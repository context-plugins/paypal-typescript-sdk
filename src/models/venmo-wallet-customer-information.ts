...
export type VenmoWalletCustomerInformation = {
  id?: string;
  emailAddress?: string;
  phone?: PhoneWithType;
  name?: Name;
...
export const venmoWalletCustomerInformationSchema: Schema<VenmoWalletCustomerInformation> =
  s.object<VenmoWalletCustomerInformation>({
